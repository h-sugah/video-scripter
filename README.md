...
- [Video Scripterとは？](#-video-scripterとは)
- [主な特徴](#-主な特徴)
- [かんたん4ステップの使い方](#-かんたん4ステップの使い方)
- [動作に必要な環境](#️-動作に必要な環境)
- [インストールと起動手順](#-インストールと起動手順)
- [初期設定（APIキーの登録）](#️-初期設定apiキーの登録)
- [データの管理場所](#-データの管理場所)
- [LAN公開モード](#-lan公開モード同一ネットワーク内の他端末からのアクセス)
- [ライセンス](#-ライセンス)
...
対応する動画形式は `.mp4` `.mov` `.m4v` `.mkv` `.webm` `.avi` です。
...
自由に利用・改変・再配布できますが、詳細な条件は [LICENSE](LICENSE) ファイルをご確認ください。
